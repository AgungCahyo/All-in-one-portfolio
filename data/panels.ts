...
export const panels: Panel[] = [
    {
        ...
        title: { en: 'Beverage\nCrafter', id: 'Peracik\nMinuman' },
        titleShort: 'Bev',
        subtitle: { en: '5+ years crafting drinks — taste, aroma & precicion in every pour', id: '5+ tahun meracik minuman — rasa, aroma & presisi dalam setiap tuangan' },
        tag: { en: 'Mocktails · Cold Infusion · Menu Engineering', id: 'Mocktail · Cold Infusion · Menu Engineering' },
        cta: { en: 'View Craft Work', id: 'Lihat Karya Peracik' },
        accent: '#d0c0b0',
        dim: '#7a6458',
        bg: '#100c08',
        photo: '/profile.png',
    ...
    },
    {
        ...
        titleShort: 'Dev',
        subtitle: { en: '3+ years shipping production apps — Saas, AI & mobile', id: '3+ tahun membangun aplikasi produksi — SaaS, AI & mobile' },
    ...
    },
    {
        ...
        titleShort: 'Video',
        subtitle: { en: 'Cinematic storytelling — corporate, documentary & brand film', id: 'Penceritaan sinematik — korporat, dokumenter & film brand' },
