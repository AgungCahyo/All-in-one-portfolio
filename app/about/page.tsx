...
export default function AboutPage() {
  ...
  return (
    <main
      ...
      style={{ background: '#f5f3f0', color: '#241f1a' }}
    >
      <motion.div
        ...
        style={{
          opacity: panelGlow,
          background:
            'radial-gradient(circle at 12% 18%, rgba(52,84,164,0.08) 0%, transparent 36%), radial-gradient(circle at 84% 12%, rgba(31,110,82,0.07) 0%, transparent 34%), radial-gradient(circle at 55% 82%, rgba(193,97,63,0.07) 0%, transparent 36%)',
        }}
      />
      ...
      <section ref={heroRef} className="relative overflow-hidden" style={{ minHeight: '100vh' }}>
        ...
        >
          <Image
            ...
            style={{ filter: 'grayscale(15%) sepia(10%) brightness(1.02) contrast(1.03)' }}
            priority
          />
        </motion.div>
        ...
        <motion.div 
          className="absolute inset-0"
          style={{
            background: 'linear-gradient(105deg, rgba(245,243,240,0.97) 0%, rgba(245,243,240,0.88) 38%, rgba(245,243,240,0.3) 65%, rgba(245,243,240,0.55) 100%)',
            opacity: gradientOpacity
          }}
        />
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(to top, #f5f3f0 0%, transparent 45%)',
        }} />

        {/* Top rule */}
        <div className="absolute top-[57px] left-0 right-0 h-px" style={{ background: 'rgba(36,31,26,0.06)' }} />
        ...
        >
          <p className="font-mono text-[9px] tracking-[0.35em] uppercase" style={{ color: 'rgba(36,31,26,0.18)' }}>
            04 / {t('About', 'Tentang')}
          </p>
        </motion.div>
        ...
        <div
          ...
          style={{ left: '52%', width: '1px', background: 'rgba(36,31,26,0.05)' }}
        />
        ...
        >
            ...
            <div className="mb-8">
              ...
              >
                ...
                >
                  <div style={{ width: '32px', height: '1px', background: 'rgba(36,31,26,0.2)' }} />
                  <span className="font-mono text-[10px] tracking-[0.4em] uppercase"
                    style={{ color: 'rgba(36,31,26,0.22)' }}>
                ...
                <div className="overflow-hidden">
                  <motion.h1
                    className="font-heading font-bold leading-[0.82] tracking-tight"
                    style={{
                  ...
                  >
                    Agung<br />
                    <span style={{ color: 'rgba(36,31,26,0.15)' }}>Cahyo</span><br />
                    Prasetyo
                  </motion.h1>
                </div>
                ...
                <motion.div 
                  className="mt-8 pt-6" 
                  style={{ borderTop: '1px solid rgba(36,31,26,0.1)' }}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{
                    duration: 0.8,
                  ...
                  <div className="grid grid-cols-3 gap-0" style={{ maxWidth: '560px' }}>
                    {[
                      ...
                      <motion.div 
                        key={i}
                        className="py-4 pr-6"
                        style={{ borderRight: i < 2 ? '1px solid rgba(36,31,26,0.08)' : 'none', paddingLeft: i > 0 ? '20px' : 0 }}
                      ...
                      >
                        <span className="font-mono text-[8px] tracking-[0.3em]"
                          style={{ color: 'rgba(36,31,26,0.2)' }}>{d.num}</span>
                        <p
                          className="font-heading text-base font-semibold mt-1 whitespace-pre-line leading-tight"
                          style={{ color: 'rgba(36,31,26,0.7)' }}
                        >
                          {t(d.en, d.id)}
                        </p>
                      </motion.div>
            ...
            >
              <p className="text-[14px] leading-relaxed mb-6" style={{ color: 'rgba(36,31,26,0.82)', textShadow: '0 1px 2px rgba(0,0,0,0.55)' }}>
                {t(
              ...
              <div className="flex items-center gap-3">
                <motion.div
                  ...
                  style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#241f1a', flexShrink: 0 }}
                />
                <span className="font-mono text-[10px] tracking-[0.25em] uppercase"
                  style={{ color: 'rgba(36,31,26,0.35)' }}>
      ...
      {/* Identity Mixer */}
      <section className="px-8 lg:px-14 py-16 relative z-10" style={{ borderTop: '1px solid rgba(36,31,26,0.07)' }}>
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-8">
          <div className="lg:col-span-4">
            <p className="font-mono text-[10px] tracking-[0.3em] uppercase mb-3" style={{ color: 'rgba(36,31,26,0.35)' }}>
              {t('Identity Mixer', 'Identity Mixer')}
            </p>
            <h3 className="font-heading text-4xl leading-[0.9] font-bold" style={{ color: '#241f1a' }}>
              {t('One mindset,', 'Satu mindset,')}<br />
              <span style={{ color: 'rgba(36,31,26,0.45)' }}>{t('three outputs.', 'tiga output.')}</span>
            </h3>
          </div>

          <div className="lg:col-span-8 grid md:grid-cols-2 gap-4">
            <div className="p-5 rounded-xl" style={{ border: '1px solid rgba(36,31,26,0.08)', background: 'rgba(36,31,26,0.02)' }}>
              <div className="flex flex-wrap gap-2 mb-4">
                {(['craft', 'code', 'cinema'] as const).map((lens) => (
                  <button
                    ...
                    style={{
                      border: `1px solid ${activeLens === lens ? lensProfiles[lens].accent : 'rgba(36,31,26,0.08)'}`,
                      color: activeLens === lens ? lensProfiles[lens].accent : 'rgba(36,31,26,0.45)',
                      background: activeLens === lens ? 'rgba(36,31,26,0.05)' : 'transparent',
                    }}
                  >
              ...
              <h4 className="font-heading text-2xl leading-tight mb-2" style={{ color: '#241f1a' }}>
                {activeProfile.title[lang]}
              </h4>
              <p className="text-[13px] leading-relaxed" style={{ color: 'rgba(36,31,26,0.62)' }}>
                {activeProfile.body[lang]}
              </p>
            </div>

            <div className="p-5 rounded-xl" style={{ border: '1px solid rgba(36,31,26,0.08)', background: 'rgba(36,31,26,0.015)' }}>
              <p className="font-mono text-[10px] tracking-[0.2em] uppercase mb-5" style={{ color: 'rgba(36,31,26,0.35)' }}>
              ...
              {[
                ...
                <div key={item.en} className="mb-4 last:mb-0">
                  <div className="flex justify-between text-[11px] mb-1">
                    <span style={{ color: 'rgba(36,31,26,0.62)' }}>{item[lang]}</span>
                    <span className="font-mono" style={{ color: activeProfile.accent }}>{activeProfile.bars[i]}%</span>
                  </div>
                  <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(36,31,26,0.08)' }}>
                    <motion.div
                      key={`${activeLens}-${i}`}
                      initial={{ width: 0 }}
                      ...
                      style={{ background: `linear-gradient(90deg, ${activeProfile.accent}, rgba(36,31,26,0.75))` }}
                    />
                  </div>
                </div>
              ))}
            ...
            <div className="md:col-span-2 p-5 rounded-xl" style={{ border: '1px solid rgba(36,31,26,0.08)', background: 'rgba(36,31,26,0.015)' }}>
              <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
                <p className="font-mono text-[10px] tracking-[0.2em] uppercase" style={{ color: 'rgba(36,31,26,0.35)' }}>
              ...
              <div className="grid lg:grid-cols-2 gap-6 items-start">
                <div className="space-y-4">
                  {([
                    ...
                    <button
                      ...
                      style={{
                        border: `1px solid ${activeBridge === key ? bridgeMap[key].accent : 'rgba(36,31,26,0.08)'}`,
                        background: activeBridge === key ? 'rgba(36,31,26,0.045)' : 'rgba(36,31,26,0.01)',
                      }}
                    >
                      <p className="font-mono text-[10px] tracking-[0.2em] uppercase mb-1" style={{ color: bridgeMap[key].accent }}>{label}</p>
                      <p className="text-[13px]" style={{ color: 'rgba(36,31,26,0.64)' }}>{bridgeMap[key].subtitle[lang]}</p>
                    </button>
                  ))}
                </div>
                ...
                <div className="p-4 rounded-lg" style={{ border: `1px solid ${activeBridgeData.accent}` }}>
                  ...
                  <h4 className="font-heading text-3xl leading-[0.95] mb-3" style={{ color: '#241f1a' }}>
                    {activeBridgeData.subtitle[lang]}
                  </h4>
                  <p className="text-[14px] leading-relaxed mb-4" style={{ color: 'rgba(36,31,26,0.64)' }}>
                    {activeBridgeData.body[lang]}
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {activeBridgeData.chips.map((chip) => (
                      <span key={chip} className="px-2.5 py-1 text-[11px] rounded-full" style={{ border: '1px solid rgba(36,31,26,0.12)', color: 'rgba(36,31,26,0.72)' }}>
                        {chip}
                      </span>
                    ))}
                  </div>
      ...
      <div style={{ borderTop: '1px solid rgba(36,31,26,0.06)' }} className="px-8 lg:px-14 py-3 flex justify-between items-center">
        <span className="font-mono text-[9px] tracking-[0.35em] uppercase" style={{ color: 'rgba(36,31,26,0.42)' }}>A — {t('Values', 'Nilai')}</span>
        <span className="font-mono text-[9px] tracking-[0.2em]" style={{ color: 'rgba(36,31,26,0.24)' }}>04.1</span>
      </div>

      {/* ══════════════════════════════ VALUES — brutalist numbered grid ══════════════════════════════ */}
      <section className="px-8 lg:px-14 py-0"
        style={{ borderTop: '1px solid rgba(36,31,26,0.06)' }}>
        <div className="max-w-7xl mx-auto">
          {values.map((v, i) => (
            <motion.div
              ...
              style={{ borderBottom: '1px solid rgba(36,31,26,0.05)' }}
            >
              {/* Number — col 1–2 */}
              <div className="col-span-2 lg:col-span-1 flex items-start pt-1">
                <span
                  className="font-heading font-bold"
                  style={{ fontSize: '2.8rem', color: 'rgba(36,31,26,0.07)', lineHeight: 1, letterSpacing: '-0.03em' }}
                >
                  {v.num}
                </span>
              </div>
              ...
              <div className="col-span-5 lg:col-span-4 pr-8 flex items-start">
                <h3
                  ...
                  style={{ fontSize: 'clamp(1.6rem, 2.8vw, 2.4rem)', color: '#241f1a', letterSpacing: '-0.02em' }}
                >
              ...
              <div className="col-span-5 lg:col-span-7 flex items-start">
                <p className="text-[13px] leading-relaxed" style={{ color: 'rgba(36,31,26,0.50)', maxWidth: '480px' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(36,31,26,0.06)' }}
        className="px-8 lg:px-14 py-3 flex justify-between items-center mt-16">
        <span className="font-mono text-[9px] tracking-[0.35em] uppercase" style={{ color: 'rgba(36,31,26,0.42)' }}>B — {t('Journey', 'Perjalanan')}</span>
        <span className="font-mono text-[9px] tracking-[0.2em]" style={{ color: 'rgba(36,31,26,0.24)' }}>04.2</span>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          {timeline.map((item, i) => (
            <motion.div
              ...
              style={{ borderBottom: '1px solid rgba(36,31,26,0.04)' }}
            >
              {/* Year + code — col 1–2 */}
              <div className="col-span-3 lg:col-span-2 pr-6">
                <p
                  className="font-heading font-bold"
                  style={{ fontSize: '1.6rem', color: 'rgba(36,31,26,0.18)', letterSpacing: '-0.02em', lineHeight: 1 }}
                >
                  {item.year}
                </p>
                <p className="font-mono text-[8px] tracking-[0.2em] mt-1" style={{ color: 'rgba(36,31,26,0.22)' }}>
                  {item.code}
                </p>
              </div>
              ...
              <div className="col-span-2 lg:col-span-1 pr-4 pt-1">
                <span
                  ...
                  style={{ border: '1px solid rgba(36,31,26,0.10)', color: 'rgba(36,31,26,0.52)' }}
                >
              ...
              <div className="col-span-7 lg:col-span-9">
                <h4
                  ...
                  style={{ fontSize: 'clamp(1.1rem, 1.8vw, 1.45rem)', color: '#5c5650', letterSpacing: '-0.01em', lineHeight: 1.2 }}
                >
                  {typeof item.title === 'string' ? item.title : item.title[lang]}
                </h4>
                <p className="text-[13px] leading-relaxed" style={{ color: 'rgba(36,31,26,0.50)', maxWidth: '560px' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(36,31,26,0.06)' }}
        className="px-8 lg:px-14 py-3 flex justify-between items-center mt-16">
        <span className="font-mono text-[9px] tracking-[0.35em] uppercase" style={{ color: 'rgba(36,31,26,0.42)' }}>C — {t('Beyond Work', 'Di Luar Kerja')}</span>
        <span className="font-mono text-[9px] tracking-[0.2em]" style={{ color: 'rgba(36,31,26,0.24)' }}>04.3</span>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          {offwork.map((item, i) => (
            <motion.div
              ...
              style={{ borderBottom: '1px solid rgba(36,31,26,0.04)' }}
            >
              <span className="font-mono text-[9px] shrink-0" style={{ color: 'rgba(36,31,26,0.24)', width: '24px' }}>
                {String(i + 1).padStart(2, '0')}
              </span>
              <p className="text-[14px]" style={{ color: 'rgba(36,31,26,0.55)' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(36,31,26,0.06)' }}
        className="px-8 lg:px-14 py-3 flex justify-between items-center mt-16">
        <span className="font-mono text-[9px] tracking-[0.35em] uppercase" style={{ color: 'rgba(36,31,26,0.42)' }}>D — {t('Contact', 'Kontak')}</span>
        <span className="font-mono text-[9px] tracking-[0.2em]" style={{ color: 'rgba(36,31,26,0.24)' }}>04.4</span>
      </div>
      ...
      >
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-end">
          ...
          <div>
            <h2
              className="font-heading font-bold leading-[0.9] mb-10"
              style={{
            ...
            <div>
              {availability.map((a, i) => (
                <div
                  ...
                  style={{ borderBottom: '1px solid rgba(36,31,26,0.05)' }}
                >
                  <span className="text-[13px]" style={{ color: 'rgba(36,31,26,0.56)' }}>
                    {typeof a.role === 'string' ? a.role : a.role[lang]}
                  </span>
                  <div className="flex items-center gap-2.5">
                    <span
                      className="w-1.5 h-1.5 rounded-full"
                      style={{ background: a.open ? '#241f1a' : '#d8d3cc' }}
                    />
                    <span
                      className="font-mono text-[9px] tracking-[0.25em] uppercase"
                      style={{ color: a.open ? 'rgba(36,31,26,0.5)' : '#b3ada3' }}
                    >
          ...
          <div className="space-y-0">
            {[
              ...
              <motion.a
                ...
                style={{ borderBottom: '1px solid rgba(36,31,26,0.05)', textDecoration: 'none' }}
              >
                <span className="font-mono text-[9px] tracking-[0.3em] uppercase"
                  style={{ color: 'rgba(36,31,26,0.30)' }}>{c.platform}</span>
                <div className="flex items-center gap-3">
                  <span className="text-[13px] transition-colors"
                    style={{ color: 'rgba(36,31,26,0.62)' }}>
                    {c.handle}
                  </span>
                  <svg className="w-3 h-3 transition-transform group-hover:translate-x-1"
                    style={{ color: 'rgba(36,31,26,0.30)' }}
            ...
            <div className="pt-8">
              <a
                ...
                style={{ color: 'rgba(36,31,26,0.42)' }}
              >
              ...
              <a
                ...
                style={{ background: '#241f1a', color: '#f5f3f0' }}
              >
      ...
      <div
        ...
        style={{ borderTop: '1px solid rgba(36,31,26,0.04)' }}
      >
        <Link href="/" className="text-[11px] flex items-center gap-2" style={{ color: 'rgba(36,31,26,0.45)' }}>
          <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 16l-4-4m0 0l4-4m-4 4h18" />
          </svg>
          {t('Back to Home', 'Kembali ke Beranda')}
        </Link>
        <span className="font-mono text-[10px] font-medium" style={{ color: 'rgba(36,31,26,0.28)' }}>
          04 / {t('About', 'Tentang')}
        </span>
        <Link href="/videographer" className="text-[11px] flex items-center gap-2" style={{ color: 'rgba(36,31,26,0.45)' }}>
